...
case class InputCell(name: String, shape: Shape /*, private var v: SimpleMatrix*/) extends Expr {
...
case class OutputCell(name: String, expr: Expr) extends Expr {
  def backwardsExpr(seed: Expr, in: Expr) = sys.error("Cannot get here")
}
